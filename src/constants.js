...
// --- Home Plate ---
export const HOME_PLATE_Y = 450;    // ホームベースのY座標 (ボールの目標地点)
...
export const BAT_CONTACT_Y_OFFSET = 95; // バットの打点Y = batter.y - この値
...
export const SWEET_SPOT_INSET = 20;   // 芯を先端から内側にシフト(px)
...
// --- Ground Shadow ---
export const GROUND_SHADOW_Y = 470;  // 地面影のY座標
