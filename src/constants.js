...
export const STRIKE_ZONE_CENTER_Y = 465;  // = BATTER_Y(545) - BAT_CONTACT_Y_OFFSET(80)
...
export const BAT_CONTACT_Y_OFFSET = 80; // バットの打点Y = batter.y - この値 (打点を下げて影がHPの上で合うように)
...
// --- Direction Mapping ---
export const DIRECTION_AMPLIFICATION_POWER = 0.5; // 増幅カーブ指数 (0.5 = sqrt)
export const DIRECTION_NORMALIZATION_RANGE = 40;   // 正規化範囲(deg)
export const JUST_TIMING_THRESHOLD_DEG = 8;        // "just"判定幅(deg) (旧5→8に拡大)
export const DIRECTION_TIMING_OFFSET_DEG = 5;      // タイミングオフセット(deg) 正=中央/左を遅め寄りに
