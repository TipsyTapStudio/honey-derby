...
export const FOUL_ANGLE_THRESHOLD = 40;   // ファウル判定角度(°) |direction|≧これならファウル (35→40: 流し打ちFOUL緩和)
...
export const DIRECTION_TIMING_OFFSET_PX = -5;      // タイミングオフセット(px) -5: 高速球の反応遅れ補正(自然なタイミングで左も出る)
...
export const TIP_DIRECTION_FACTOR = 0.2;     // °/px: signedGap(+右=TIP, -左=ROOT) × この値が方向に加算 (0.3→0.2: 流し打ちFOUL緩和)
